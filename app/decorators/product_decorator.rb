class ProductDecorator < Draper::Base
  ...
  def json_to_browse
     ...
     # collection = h.current_user.user.cart_items.where('cart_items.variant_id =?', product.variants.first.id)
    #end
    #collection_action = (h.current_user.user && collection) ? 'unhallit' : 'hallit'
