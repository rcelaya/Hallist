...
ActiveRecord::Schema.define(:version => 20130804234036) do
  ...
  create_table "users", :force => true do |t|
    ...
    t.integer  "brand_id"
    t.boolean  "artist"
    t.boolean  "enable_to_sell"
    t.string   "single_access_token"
    t.integer  "sash_id"
    t.integer  "level",               :default => 0
    t.integer  "sells_counter",       :default => 0, :null => false
    t.integer  "shoppings_counter",   :default => 0, :null => false
  end
